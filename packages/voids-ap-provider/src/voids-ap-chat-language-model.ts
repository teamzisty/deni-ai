...
import { getResponseMetadata } from "@ai-sdk/openai-compatible/internal";
import { mapOpenAICompatibleFinishReason } from "@ai-sdk/openai-compatible/internal";
import type {
  VoidsAPChatModelId,
  VoidsAPChatSettings,
} from "./voids-ap-chat-settings";
...
export class VoidsAPChatLanguageModel implements LanguageModelV1 {
  readonly specificationVersion = "v1";

  readonly supportsStructuredOutputs: boolean;

  readonly modelId: VoidsAPChatModelId;
  readonly settings: VoidsAPChatSettings;

  private readonly config: VoidsAPChatConfig;
