  ...
  <Layout>
    <template #doc-before>
      <div class="blog-post-header" v-if="isBlogPost">
        <h1 class="blog-post-title" style="font-size: 1.5rem; font-weight: bold">{{ frontmatter.title }}</h1>
...
const isBlogPost = computed(() => {
  return route.path.includes('/blog/posts/') || route.path.includes('/ja/blog/posts/')
})
