...
<Alert variant="default" title="Note" description="This project is published under the MIT license. Therefore, you are free to change the brand name, but credit attribution is required.
