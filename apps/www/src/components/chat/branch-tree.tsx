    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <CollapsibleTrigger asChild>
        <Button variant="ghost" size="sm" className="flex items-center gap-2">
          ...
          {branchTree.branches.length} {branchTree.branches.length === 1 ? 'branch' : 'branches'}
        </Button>
      </CollapsibleTrigger>
        ...
        <div className="ml-6 border-l border-border pl-4 space-y-2">
          ...
          {branchTree.root && (
            <div className="flex items-center gap-2">
              ...
              <Button
                variant={currentConversationId === branchTree.root.id ? "secondary" : "ghost"}
                size="sm"
          ...
          {branchTree.branches.map((branch) => (
            <div key={branch.id} className="flex items-center gap-2">
              ...
              <Button
                variant={currentConversationId === branch.id ? "secondary" : "ghost"}
                size="sm"
