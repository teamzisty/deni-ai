...
export const ChatContextMenu = memo(
  ({ session, children }: ChatContextMenuProps) => {
                    ...
                    {hubs.map((hub) => {
                      ...
                      return (
                        <ContextMenuItem
                          ...
                          disabled={isInHub}
                          className={
                            isInHub ? "opacity-50 cursor-not-allowed" : ""
                          }
                        >
                  ...
                  <ContextMenuSub>
                    ...
                    <ContextMenuSubContent className="w-48">
                      {chatHubs.map((hub) => (
                        <ContextMenuItem
                          key={hub.id}
                          onClick={() => handleRemoveFromHub(hub.id)}
                        >
                          <Folder className="mr-2 h-4 w-4" />
                          <span className="truncate">{hub.name}</span>
                        </ContextMenuItem>
