    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          </div>          <Badge variant={hasMFA ? "default" : "secondary"}>
        ...
        {hasMFA ? (
          <div className="space-y-4">
            <div className="p-4 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
              <div className="flex items-center space-x-2">
                <ShieldCheck className="h-5 w-5 text-green-600" />                <span className="font-medium text-green-800 dark:text-green-200">
                  {t("enabledStatus")}
                </span>
              </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t("addedOn", { date: new Date(factor.created_at).toLocaleDateString() })}
                    </p>
                  </div>
                  <Button
                    variant="outline"
          ...
          <div className="space-y-4">
            <div className="p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg border border-yellow-200 dark:border-yellow-800">              <div className="flex items-center space-x-2">
