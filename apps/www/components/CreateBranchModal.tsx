...
export function CreateBranchModal({ open, onOpenChange, currentSession }: CreateBranchModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {t('createBranchModal.description', { parentTitle: currentSession.title || "Session" })}
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button type="submit" onClick={handleCreateBranch} disabled={isLoading || !branchName.trim()}>
