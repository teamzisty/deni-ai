    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-none border-b border-border p-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold">{t('intellipulseHomePage.title')}</h1>
        </div>
      </div>
        ...
        <div className="max-w-2xl w-full space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground text-lg">
              Start a conversation to begin your development session. Ask questions, get code assistance, or explore ideas.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <button
              onClick={() => setInputMessage("Help me create a new React component")}
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">Get help building a new React component</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">Find and fix issues in your code</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-muted-foreground">Understand how code works</div>
            </button>
            
            <button
              onClick={() => setInputMessage("Optimize my application performance")}
              className="p-4 text-left rounded-lg border border-border hover:bg-accent hover:text-accent-foreground transition-colors"
            >
              <div className="font-medium">Performance Tips</div>
              <div className="text-sm text-muted-foreground">Improve your app's performance</div>
            </button>
          </div>
        </div>
      </div>
