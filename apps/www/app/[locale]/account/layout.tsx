    ...
    <ChatSessionsProvider>
      <SettingsDialogProvider>
        <div className="min-h-screen flex flex-col">
          <header className="w-screen h-16 bg-secondary/70">
          ...
          <main className="flex-1 w-screen max-w-4xl  mx-auto flex items-center justify-center py-8">
            <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] md:max-h-[640px] sm:h-[calc(100vh-164px)] h-full bg-secondary/60 p-8 rounded-lg gap-8 max-w-7xl w-full ">
