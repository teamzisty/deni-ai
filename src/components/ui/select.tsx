    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Positioner align={align} sideOffset={4}>
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative z-50 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border bg-popover text-popover-foreground shadow-md outline-none transition-[opacity,scale] data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0",
            className,
          )}
          {...props}
        >
  ...
  return (
    ...
    >
      <span
        ...
        className="absolute right-2 top-1/2 -translate-y-1/2 flex !w-3.5 size-3.5 items-center justify-center"
      >
