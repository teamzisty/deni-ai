...
function DialogTrigger({
  ...
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" {...resolveRenderProps(props)} />;
}
...
function DialogClose({
  ...
  return <DialogPrimitive.Close data-slot="dialog-close" {...resolveRenderProps(props)} />;
}
